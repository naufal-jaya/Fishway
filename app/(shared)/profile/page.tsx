...
export default async function ProfilePage() {
  ...
  // Cek apakah user adalah penjual (punya store)
            ...
            {addresses.find(a => a.is_primary) ? (
              <div className="text-sm text-gray-700 space-y-1">
                <p className="font-medium">
                  {addresses.find(a => a.is_primary)?.recipient_name} · {addresses.find(a => a.is_primary)?.phone}
                </p>
              ...
              <p className="text-sm text-gray-500">
                ...
                <Link href="/profile/edit" className="text-primary hover:underline">Tambah sekarang</Link>
              </p>
            )}
          </div>
